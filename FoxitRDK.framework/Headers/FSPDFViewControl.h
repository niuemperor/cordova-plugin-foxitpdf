...
@protocol FSPDFUIExtensionsManager <IGestureEventListener, IDrawEventListener>
@optional
/** 
 ...
 *											Basically it is same frame as UIView of PDF viewer control.
 *			</li>
 *			<li>
 ...
 *
 * @param[in]	cleanup		A callback function to clean up caller resources.
 *
 * @return	None.
 */
...
/** 
 * @brief	Check if there is a page in front of current page on the page navigation stack.
 *
 * @details	PDF view control keeps a stack to track page navigation.
 *
...
- (BOOL)hasPrevView;
/** 
 * @brief	Check if there it is a page next to the current page on the page navigation stack.
 *
 * @details	PDF view control keeps a stack to track page navigation.
 *
 ...
 *
 * @details	Overlay view is on top of the page view，visual effects such as the highlight on text, will be draw on it.
 *			To draw on the overlay view, IDrawEventListener should be registered first.
 *
 * @param[in]	pageIndex	Page index. Valid range: from 0 to (<i>count</i>-1).
 *							<i>count</i> is the page count. <br>
 *							The page specified by this index should be visible.
